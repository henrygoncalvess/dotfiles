...
PROGRAMS=(curl git python3 python3-pip python3-venv wget make cmake ripgrep stow xclip wl-clipboard cliphist tar waybar cava brightnessctl network-manager cheese mako-notifier libnotify-bin gparted pkg-config unzip flameshot libqalculate-dev swaybg swaylock swayidle sway pavucontrol lxpolkit xdg-desktop-portal software-properties-common xdg-desktop-portal-gtk flatpak zsh fzf bluez libbluetooth-dev bat perl golang gcc clang libdrm-dev libgbm-dev meson build-essential flex bison ninja-build cmake-extras gettext gettext-base fontconfig libfontconfig-dev libffi-dev libxkbcommon-x11-dev libxkbregistry-dev libxkbcommon-dev libudev-dev libseat-dev seatd libegl-dev glslang-tools libinput-bin libinput-dev libavutil-dev libavcodec-dev libavformat-dev libxcb-ewmh-dev libxcb-present-dev libxcb-xinput-dev libwayland-dev wayland-protocols libstdc++6 qt6-base-dev qt6-wayland-dev)
