...
stow -v -D -t ~ conf_posh conf_code conf_git conf_lvim conf_shell conf_kitty conf_sway conf_waybar conf_wofi conf_pip
...
cd ~/.dotfiles
stow -v -t ~ conf_posh conf_code conf_git conf_lvim conf_shell conf_kitty conf_sway conf_waybar conf_wofi conf_pip
