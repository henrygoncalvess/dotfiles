...
stow -v -D -t ~ conf_posh conf_code conf_git conf_lvim conf_shell conf_kitty conf_waybar conf_rofi conf_pip conf_hypr
...
cd ~/.dotfiles
stow -v -t ~ conf_posh conf_code conf_git conf_lvim conf_shell conf_kitty conf_waybar conf_rofi conf_pip conf_hypr
