...
Item {
    ...
    // Auth nativa via PamContext do quickshell. No Ubuntu+nix isso NÃO funciona (o
    // quickshell nix carrega pam_unix/unix_chkpwd do nix, não-setuid) — por isso aqui
    // o locker de verdade é o hyprlock (ver hypridle.conf). No Arch/Omarchy o quickshell
    // é nativo e usa o PAM do sistema, então esse PamContext autentica de boa.
    PamContext {
        id: pam
